...
explain what the heck happened and what it all means
...
nsim <- 5000  # number of simulations to run for each p_res
...
legend("topleft", legend=c("sim estimates", "true abundance", "theoretical"),
